...
import com.example.securechatapp.data.local.dao.ConversationMediaTagCacheDao
...
@Database(
    entities = [
        ...
        ConversationMediaTagCacheEntity::class,
...
abstract class SecureChatDatabase : RoomDatabase() {
    ...
    abstract fun conversationMediaTagCacheDao(): ConversationMediaTagCacheDao
